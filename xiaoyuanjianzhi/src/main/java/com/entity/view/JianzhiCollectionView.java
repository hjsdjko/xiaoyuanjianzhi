...
*/
@TableName("jianzhi_collection")
public class JianzhiCollectionView extends JianzhiCollectionEntity implements Serializable {
	...
	*/
	...
	private String jianzhiCollectionValue;
	...
	public JianzhiCollectionView() {

	}

	public JianzhiCollectionView(JianzhiCollectionEntity jianzhiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, jianzhiCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getJianzhiCollectionValue() {
		return jianzhiCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setJianzhiCollectionValue(String jianzhiCollectionValue) {
		this.jianzhiCollectionValue = jianzhiCollectionValue;
	}
	...
	public String toString() {
		return "JianzhiCollectionView{" +
			", jianzhiCollectionValue=" + jianzhiCollectionValue +
