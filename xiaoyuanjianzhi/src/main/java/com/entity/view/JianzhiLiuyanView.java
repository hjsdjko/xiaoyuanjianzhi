...
public class JianzhiLiuyanView extends JianzhiLiuyanEntity implements Serializable {
	...
	public JianzhiLiuyanView() {

	}

	public JianzhiLiuyanView(JianzhiLiuyanEntity jianzhiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, jianzhiLiuyanEntity);
